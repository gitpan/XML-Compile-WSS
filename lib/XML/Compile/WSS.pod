...
You will certainly need the constants from L<XML::Compile::WSS::Util|XML::Compile::WSS::Util>.
Besides, when you want to use Security with SOAP, then use
L<XML::Compile::SOAP::WSS|XML::Compile::SOAP::WSS>.
...
This module is part of XML-Compile-WSS distribution version 1.01,
built on October 18, 2012. Website: F<http://perl.overmeer.net/xml-compile/>
